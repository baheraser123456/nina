...
class dftwTotal extends StatefulWidget {
  const dftwTotal({super.key});
  static String name = 'dftotal';

  @override
  State<dftwTotal> createState() => _TotalState();
}

class _TotalState extends State<dftwTotal> {
  @override
  void initState() {
    super.initState();
        ...
        if (state is Totalsuc) {
          return Scaffold(
              ...
              body: Column(
                ...
                children: [
                  _createDataTables(
                      context: context, A: "الاجمالي", day: 'اليوم'),
                  Expanded(
