...
class cardspages extends StatefulWidget {
  ...
  static const name = 'cardsS';

  @override
  State<cardspages> createState() => _hhhState();
}

class _hhhState extends State<cardspages> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    BlocProvider.of<DatacubitCubit>(context).getcards(name);
