...
class DeleteCards extends StatefulWidget {
  const DeleteCards({super.key});
  static const name = 'DeleteCards';

  @override
  State<DeleteCards> createState() => _DeleteCardsState();
}

class _DeleteCardsState extends State<DeleteCards> {
                      ...
                      child: SizedBox(
                        ...
                        child: BlocListener<DelcubitCubit, DelcubitState>(
                          ...
                          child: custbutton(
                            hint: 'حذف',
                            fun: () {
                              BlocProvider.of<DelcubitCubit>(context).delcard(
