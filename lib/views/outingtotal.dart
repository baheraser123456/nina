...
class OutTotal extends StatefulWidget {
  const OutTotal({super.key});
  static String name = 'outtotal';

  @override
  State<OutTotal> createState() => _TotalState();
}

class _TotalState extends State<OutTotal> {
  @override
  void initState() {
    super.initState();
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: _createDataTable(
                              context: context,
                              A: state.data['data'][index]['outingtotal']
                                  .toString(),
